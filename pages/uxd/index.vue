...
export default {
  ...
  head() {
    ...
    return {
      title,
      meta: createSEOMeta({title, description, url: 'uxd', image: og_image.filename ? og_image.filename : 'https://a.storyblok.com/f/117396/1200x627/8beb321b38/meta-image.png' })
    }
  },
}
</script>
